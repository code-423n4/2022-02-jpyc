...
function shouldBehaveLikePausable (errorPrefix, pauser, owner, anotherAccount, initialSupply, initialHolder, recipient, masterMinter) {
  ...
  describe('pausable token', function () {
    ...
    describe('configureMinter', function () {
      ...
      it('reverts when trying to configureMinter when pausd', async function () {
        ...
        await expectRevert(this.token.configureMinter(minter, value, { from: masterMinter }),
          `${errorPrefix}: paused`,
        );
      });
    });
